...
require (
	...
	github.com/gohugoio/hugo v0.159.0 // indirect
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20260324095636-8e791c9428a2 // indirect
	...
	github.com/ydb-platform/ydb-go-sdk/v3 v3.128.2 // indirect
